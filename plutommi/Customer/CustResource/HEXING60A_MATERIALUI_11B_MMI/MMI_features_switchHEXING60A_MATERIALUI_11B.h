...
/*
  ...
  Reference: 
*/
#define CFG_MMI_MULTITAP	(__ON__)
...
*/
#define CFG_MMI_CALENDAR_EVENT	(__ON__)
...
*/
#define CFG_MMI_UM_CONVERSATION_BOX	  (__ON__)
...
*/
#define CFG_MMI_UM_CONVERSATION_BOX_ENHANCE(__ON__)
...
/*
  ...
  Reference: FRS_APP_UNIFIEDMESSAGE_09B_Latest_0125.doc
*/
#define CFG_MMI_UM_CONVERSATION_BOX_WITH_OUTBOX	(__ON__)
...
*/
#define CFG_MMI_KEY_ONLY_NCENTER	(__OFF__)
...
/*
  ...
  Reference: 
*/
#define CFG_MMI_VUI_HOMESCREEN_LIVE_WALLPAPER_INTERACTIVE_VIDEO	(__OFF__)
...
/*
  ...
  Reference: DD_APP_PhoneSetup.doc
*/
#define CFG_MMI_SCREEN_SWITCH_EFFECT_SETTING	(SSE_SETTING_NONE)
...
*/
#define CFG_MMI_EM_NW_WCDMA_PREFERRED	(__OFF__)
...
*/
#define CFG_MMI_OP02_WO_PORTAL	(__OFF__)
...
*/
#define CFG_MMI_3D_MEDIA_CENTER	(__OFF__)
