...
/* without status bar */
const U8 category14_matrix_page[] = 
{
    5,
    DM_BASE_LAYER_START,
    DM_SCR_BG,
...
const S16 coordinate_set14_Matrix_Page[] = 
{
    DM_FULL_SCREEN_COORDINATE_FLAG,
    MAIN_MENU_MATRIX_AREA_X_GAP, 0, MAIN_LCD_DEVICE_WIDTH - MAIN_MENU_MATRIX_AREA_X_GAP * 2, MAIN_LCD_DEVICE_HEIGHT - MMI_BUTTON_BAR_HEIGHT - MAIN_MENU_CONTROL_AREA_HEIGHT, DM_NO_FLAGS,
    0, MAIN_LCD_DEVICE_HEIGHT - MMI_BUTTON_BAR_HEIGHT - MAIN_MENU_CONTROL_AREA_HEIGHT, MAIN_LCD_DEVICE_WIDTH, MAIN_MENU_CONTROL_AREA_HEIGHT, DM_NO_FLAGS,
    DM_DEFAULT_BUTTON_BAR,
    DM_NO_FLAGS,
    MMI_SOFTKEY_WIDTH
};
...
const S16 coordinate_set14_Matrix_Page[] = 
{
    DM_FULL_SCREEN_COORDINATE_FLAG,
    DM_DEFAULT_STATUS_BAR_FLAG,
    MAIN_MENU_MATRIX_AREA_X_GAP, MMI_STATUS_BAR_HEIGHT, MAIN_LCD_DEVICE_WIDTH - MAIN_MENU_MATRIX_AREA_X_GAP * 2, MAIN_LCD_DEVICE_HEIGHT - MMI_BUTTON_BAR_HEIGHT - MAIN_MENU_CONTROL_AREA_HEIGHT - MMI_STATUS_BAR_HEIGHT, DM_NO_FLAGS,
    0, MAIN_LCD_DEVICE_HEIGHT - MMI_BUTTON_BAR_HEIGHT - MAIN_MENU_CONTROL_AREA_HEIGHT, MAIN_LCD_DEVICE_WIDTH, MAIN_MENU_CONTROL_AREA_HEIGHT, DM_NO_FLAGS,
    DM_DEFAULT_BUTTON_BAR,
    DM_NO_FLAGS,
    MMI_SOFTKEY_WIDTH
...
#if !defined(__MMI_FTE_SUPPORT__) && (defined (__MMI_MAINLCD_240X320__) || defined (__MMI_MAINLCD_320X240__)) && defined (__MMI_TOUCH_DIAL_SCREEN__)
const U8 category16[] = 
{
    5,
    DM_NEW_LAYER_START,
...
/* 061507 128x160 touch Start */
#elif defined (__MMI_MAINLCD_176X220__) || defined (__MMI_MAINLCD_240X320__) || defined (__MMI_MAINLCD_320X240__) || defined (__MMI_MAINLCD_240X400__)
...
const S16 coordinate_set88_1_item[] = 
{
    ...
    MMI_COMMON_CONTENT_X, (MMI_COMMON_CONTENT_Y + (MMI_COMMON_CONTENT_HEIGHT >> 2) - 1), MMI_COMMON_CONTENT_WIDTH, 0 /* unused */, DM_SLIDE_CONTROL_VALUE_POS_NEXT_LINE,
#else /* __MMI_MAINLCD_128X64__ */
...
#elif defined(__MMI_MAINLCD_320X480__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_128X160__)
const U8 category105[] = 
{
    6,
    DM_BASE_LAYER_START,
...
//DM_DUMMY_COORDINATE,
//DM_DUMMY_COORDINATE,
MMI_COMMON_CONTENT_X + CAT111_MARGIN, MMI_COMMON_CONTENT_Y + MMI_COMMON_CONTENT_HEIGHT - (MMI_MENUITEM_HEIGHT << 1)+(MMI_TITLE_HEIGHT >> 1)+3+2, MMI_COMMON_CONTENT_WIDTH - (CAT111_MARGIN << 1), MMI_MENUITEM_HEIGHT, DM_NO_FLAGS,    /* scroll text position calculated from buttom */
DM_DUMMY_COORDINATE
...
#if defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__) || defined(__MMI_MAINLCD_320X240__) 
...
#if defined ( __MMI_MAINLCD_240X320__) || defined ( __MMI_MAINLCD_240X400__) || defined ( __MMI_MAINLCD_320X480__) || defined ( __MMI_MAINLCD_360X640__) 
    ...
    /* The sequence of category id should be listed in ascending order */
{
    ...
    {MMI_CATEGORY14_MATRIX_PAGE_ID, (U8 *) category14_matrix_page, (S16 *) coordinate_set14_Matrix_Page, NULL},
...
#if defined ( __MMI_MAINLCD_240X320__) || defined ( __MMI_MAINLCD_320X240__) || defined ( __MMI_MAINLCD_240X400__) || defined ( __MMI_MAINLCD_320X480__) || defined ( __MMI_MAINLCD_360X640__) 
