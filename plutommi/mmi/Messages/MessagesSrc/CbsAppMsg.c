...
#ifdef __CB_PLAY_SOUND_PROMPT__
		{
            cb_previous_audio_mode = mdi_audio_get_audio_mode();
            mdi_audio_set_audio_mode(AUD_MODE_LOUDSPK);
            Media_SetOutputVolume(255, 0);
			srv_prof_play_tone_with_id(SRV_PROF_TONE_FM, AUD_ID_CB_ALERT, SRV_PROF_RING_TYPE_ONCE, NULL);
			srv_gpio_play_vibrate(VIB_PATTERN_A, PLAY_ONCE);
		}
#endif
/* 20260425 */
    }
...
/* 20260425 */
			...
			srv_gpio_play_vibrate(VIB_PATTERN_A, PLAY_STOP);
            mdi_audio_set_audio_mode(cb_previous_audio_mode);
#endif
/* 20260425 */
