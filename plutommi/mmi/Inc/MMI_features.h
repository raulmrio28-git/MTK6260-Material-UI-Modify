...
*/
    ...
    #define __MMI_CHAR_SET_GB18030__	//#define __MMI_CHAR_SET_GB2312__
#endif
...
*****************************************************************************/
...
#if (((defined(__MMI_TOUCH_SCREEN__) && (defined(__MMI_IME_VK_TYPE_QWERTY__) || defined(__MMI_IME_VK_TYPE_ALPHANUMERIC__) || !defined(__NO_HANDWRITING__))) && defined (__MMI_IME_V3__)) || ((defined(__MMI_TOUCH_SCREEN__) && (!defined(__MMI_QWERTY_KEYPAD_SUPPORT__) || defined(__COSMOS_MMI_PACKAGE__))) && !defined(__MMI_IME_V3__)))
...
#if defined(CFG_MMI_MRE_APP_TWITTER_CAMERA_SUPPORT) && ((CFG_MMI_MRE_APP_TWITTER_CAMERA_SUPPORT == __ON__)||(CFG_MMI_MRE_APP_TWITTER_CAMERA_SUPPORT == __AUTO__)) && \
	(defined(__MMI_MRE_APP_TWITTER__) || defined (__MMI_MRE_APP_TWITTER_SHORTCUT__))
	#ifndef __MMI_MRE_APP_TWITTER_CAMERA_SUPPORT__
	#define __MMI_MRE_APP_TWITTER_CAMERA_SUPPORT__
	#endif
#endif


#if ((defined(__MMI_MRE_APP_TWITTER__) || defined (__MMI_MRE_APP_TWITTER_SHORTCUT__)) && !defined(__MMI_MRE_APP_TWITTER_KEY_SUPPORT__) && !defined(__MMI_MRE_APP_TWITTER_CAMERA_SUPPORT__) && !defined(__MMI_MAINLCD_176X220__) && !defined(__MMI_MAINLCD_220X176__) && !defined(__MMI_MAINLCD_128X160__))
	#error "Setting conflict. Please turn on CFG_MMI_MRE_APP_TWITTER_KEY_SUPPORT if project is non-fulltouch and/or turn on CFG_MMI_MRE_APP_TWITTER_CAMERA_SUPPORT if need Twitter Camera version"
#endif
	...
	(defined(__MMI_CALENDAR__)) || (defined(__MMI_JSR_75_PIM_SUPPORT__) && !defined(__COSMOS_MMI_PACKAGE__))
...
#if (defined(__COSMOS_MMI_PACKAGE__) && !defined(__MMI_CCA_SUPPORT__))
	#error "Dependence conflict, please turn on CFG_MMI_CCA_SUPPORT on COSMOS if want to supprot provisioning feature"
#endif
...
#define __MMI_UI_CATEGORY_DIAL_TYPE_SEL__	DIAL_TYPE_DEFAULT
...
#if (defined(__ATV_SUPPORT__) && (defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X240__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__) || defined(__MMI_MAINLCD_480X800__)))
...
#if (defined(__LOW_COST_SUPPORT_COMMON__) && (defined(__MMI_MAINLCD_96X64__)||defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_240X320__)))
	#ifndef __MMI_SLIM_IMG_RES__
	//#define __MMI_SLIM_IMG_RES__      //caoweijie del 
	#endif
#endif
...
#if ((defined(__MMI_AUDIO_PLAYER__) && (!defined(__MMI_AUDIO_PLAYER_ULTRA_SLIM__))&& (defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X240__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__)) || defined(__MMI_SLIM_IMG_RES__)))
...
#if (defined(WAP_SUPPORT) && !defined(__SLIM_PUSH_FEATURE_SUPPORT__))
	...
	(defined(__MMI_BT_SUPPORT__) && defined(__FLIGHT_MODE_SUPPORT__) && !defined(__MMI_BT_SLIM__))
...
#if (defined(__MMI_LANG_TR_CHINESE__) || defined(__MMI_LANG_SM_CHINESE__) ||defined(__MMI_INDICAL__) || defined(__MMI_HIJRI_CALENDAR__))
	#ifndef __MMI_CALENDAR_CHINESE_SUPPORT__
	#define __MMI_CALENDAR_CHINESE_SUPPORT__
	#endif
#endif


#if defined(CFG_MMI_CALENDAR_EVENT) && ((CFG_MMI_CALENDAR_EVENT == __ON__)||(CFG_MMI_CALENDAR_EVENT == __AUTO__)) && \
	(defined(__MMI_CALENDAR__)) || (defined(__MMI_TODOLIST__))
...
#if defined(CFG_MMI_CALENDAR_FDOW) && ((CFG_MMI_CALENDAR_FDOW == __ON__)||(CFG_MMI_CALENDAR_FDOW == __AUTO__)) && \
	(defined (__MMI_CALENDAR__))
	#ifndef __MMI_CALENDAR_FDOW__
	#define __MMI_CALENDAR_FDOW__
	#endif
#endif
...
#if defined(CFG_MMI_CALENDAR_NEW_STYLE) && ((CFG_MMI_CALENDAR_NEW_STYLE == __ON__)||(CFG_MMI_CALENDAR_NEW_STYLE == __AUTO__)) && \
	(defined(__MMI_CALENDAR__))
	#ifndef __MMI_CALENDAR_NEW_STYLE__
	#define __MMI_CALENDAR_NEW_STYLE__
	#endif
#endif


#if (defined(CFG_MMI_OP11_HOMESCREEN_VERSION)) &&\
	 (defined(__OP11_0800__))
	#ifndef __MMI_OP11_HOMESCREEN_VERSION__
	#define __MMI_OP11_HOMESCREEN_VERSION__	CFG_MMI_OP11_HOMESCREEN_VERSION
	#endif
#endif


#if (defined(__MMI_OP11_HOMESCREEN_VERSION__) && (__MMI_OP11_HOMESCREEN_VERSION__ == 1))
	#ifndef __MMI_OP11_HOMESCREEN_0301__
	#define __MMI_OP11_HOMESCREEN_0301__
	#endif
#endif


#if (defined(__MMI_OP11_HOMESCREEN_VERSION__) && (__MMI_OP11_HOMESCREEN_VERSION__== 2))
	#ifndef __MMI_OP11_HOMESCREEN_0302__
	#define __MMI_OP11_HOMESCREEN_0302__
	#endif
#endif


#if ((defined(__MMI_OP11_HOMESCREEN_0301__) || defined(__MMI_OP11_HOMESCREEN_0302__)) && defined(__MMI_MAINLCD_128X160__))
	#ifndef __MMI_OP11_HOMESCREEN_US__
	#define __MMI_OP11_HOMESCREEN_US__
	#endif
#endif
	...
	//#define __MMI_VIDEO_RECORDER__  //  zhangping del
	#endif
#endif
	...
	#ifndef __MMI_CAT1X_0P11_SUPPORT__
	#define __MMI_CAT1X_0P11_SUPPORT__
	#endif
#endif
...
#if (defined(__MMI_CALENDAR__) && defined(__MMI_TODOLIST__) && (defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X240__) ||  defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__)))
	#ifndef __MMI_CLNDR_EVENT_INFO__
	#define __MMI_CLNDR_EVENT_INFO__
	#endif
#endif
...
/* under construction !*/
...
#if defined(CFG_MMI_LANG_KOREAN) && ((CFG_MMI_LANG_KOREAN == __ON__)||(CFG_MMI_LANG_KOREAN == __AUTO__))
	#ifndef __MMI_LANG_KOREAN__
	#define __MMI_LANG_KOREAN__
	#endif
#endif

#if defined(CFG_MMI_LANG_JAPANESE) && ((CFG_MMI_LANG_JAPANESE == __ON__)||(CFG_MMI_LANG_JAPANESE == __AUTO__))
	#ifndef __MMI_LANG_JAPANESE__
	#define __MMI_LANG_JAPANESE__
	#endif
#endif
	...
	(defined(__MMI_DOWNLOAD_AGENT__) && defined(__HTTP_INTERFACE__)) || ((defined(__SOCIAL_NETWORK_SUPPORT__) || defined(__MMI_VPP_UPGRADE__) || defined(PGDL_SUPPORT_YOUTUBE)) && (defined(__MMI_DOWNLOAD_AGENT__) && defined(__HTTP_INTERFACE__)))
...
/* 20260423 */
#if defined(__MATERIAL_UI_THEME_MODIFY_IDLE__)
	#ifndef __MMI_DIGITAL_CLOCK_IMAGE_NUMBER__
	#define __MMI_DIGITAL_CLOCK_IMAGE_NUMBER__
	#endif
#endif
...
// baiwenlin 20130830  
	...
	#define __MMI_DUAL_SIM_DYNAMIC_MODE__
	#endif
#endif
...
/* under construction !*/
	...
	(defined(__MMI_FILE_MANAGER__)) && (((defined(__32_32_SEG__)||defined(__24_32_SEG__)||defined(__16_32_SEG__)) && !defined(__COSMOS_MMI_PACKAGE__)) || (defined(__COSMOS_MMI_PACKAGE__) && defined(__COSMOS_NO_USER_DRIVE__)))
	...
	(defined(__MMI_FILE_MANAGER__)) || (defined(__MMI_ULTRA_SLIM_FILE_MANAGER__) || defined(__LOW_COST_SUPPORT_COMMON__))
...
#if (defined(__OP01__) && (defined(MMI_MAX_SIM_NUM) && (MMI_MAX_SIM_NUM >= 2)) && defined(__MMI_GPRS_FEATURES__) && defined(__MMI_ENGINEER_MODE__))
	#ifndef __MMI_EM_NW_GPRS_CONN__
	#define __MMI_EM_NW_GPRS_CONN__
	#endif
#endif
...
#if (defined(__PLUTO_MMI_PACKAGE__) && ((defined(MP4_DECODE) || defined(MJPG_DECODE) || defined(__RM_DEC_SUPPORT__)) && !defined(__MMI_MEDIA_PLAYER__)))
	#ifndef __MMI_VIDEO_PLAYER__
	//#define __MMI_VIDEO_PLAYER__   //  zhangping del
	#endif
#endif
...
/* under construction !*/
...
#if defined(CFG_MMI_FIXED_DIALER_FONT) && ((CFG_MMI_FIXED_DIALER_FONT == __ON__)||(CFG_MMI_FIXED_DIALER_FONT == __AUTO__))
	#ifndef __MMI_FIXED_DIALER_FONT__
	#define __MMI_FIXED_DIALER_FONT__
	#endif
#endif
	...
	(defined(__32_32_SEG__) || defined(__24_32_SEG__) || defined(__16_32_SEG__))
...
#define __MMI_GDI_LAYER_FRAMEBUF_ALIGNMENT__	32
...
#if (defined(__MMI_TOUCH_SCREEN__)&& !defined(__32_32_SEG__) && !defined(__16_32_SEG__) && !defined(__24_32_SEG__))
	...
	((((defined(__MMI_IME_PREFER_WRITING_LANG__) || defined(__MMI_IME_MIXED_LANG_SUPPORT__)) && !(defined(__MMI_MULTITAP_FOR_STAR_AND_POUND__) && !defined(__MMI_TOUCH_SCREEN__)) && !(defined(__MMI_REDUCED_KEYPAD__) && !defined(__MMI_FTE_SUPPORT__)))))
...
#if (((defined(__MMI_IME_FTE_ENHANCE__) && defined(__MMI_VIRTUAL_KEYBOARD__) && (defined( __MMI_SMART_FIRST_UPPERCASE__) || defined(__MMI_MULTITAP_FIRST_UPPERCASE__))) && !defined(__MMI_IME_SLIM__)))
...
/* under construction !*/
...
#if (defined(__MMI_BASIC_UI_STYLE__) && (defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_96X64__))) ||\
...
#if ((!defined(__MMI_BASIC_UI_STYLE__) && (!(defined(__COSMOS_MMI_PACKAGE__) && defined(LOW_COST_SUPPORT))))) ||\
	 (defined(__MMI_EMAIL__) ||  defined(__MMI_IMPS__) || defined(__MMI_POC__) || defined(__SYNCML_SUPPORT__) || defined(__MMI_VOIP__))
	#ifndef __MMI_INLINE_ITEM_IMAGETEXT__
	#define __MMI_INLINE_ITEM_IMAGETEXT__
	#endif
#endif
...
#if ((!defined(__MMI_BASIC_UI_STYLE__)) || (defined(__MMI_TODOLIST__)  || defined(__MMI_FM_RADIO__) || defined(__MMI_FM_RADIO_SCHEDULE_REC__)))
	#ifndef __MMI_INLINE_ITEM_TIME_PEROID__
	#define __MMI_INLINE_ITEM_TIME_PEROID__
	#endif
#endif
	...
	#ifndef __MMI_JAVA_CATEGORY_SUPPORT__
	#define __MMI_JAVA_CATEGORY_SUPPORT__
	#endif
#endif
...
#define __MMI_MESSAGES_DRAFT_BOX__
...
#if (defined(__OP01__) && defined(__MMI_MMS_2__) && !defined(__MMI_SLIM_MMS_2__))
	#ifndef __MMI_MMS_2_RETRIVAL_MODE_SETTING__
	#define __MMI_MMS_2_RETRIVAL_MODE_SETTING__
	#endif
#endif


#if (defined(__OP12__) && defined(__MMI_MMS_2__))
	#ifndef __MMI_MMS_AUTO_DWNLD_IMMED_NOTI_AFTER_INTERRUPT__
	#define __MMI_MMS_AUTO_DWNLD_IMMED_NOTI_AFTER_INTERRUPT__
	#endif
#endif


#if (defined(__MMI_MMS_2__ ) && defined(__OP02__))
	#ifndef __MMI_MMS_AUTO_SWITCH_TO_FIRST_SLIDE__
	#define __MMI_MMS_AUTO_SWITCH_TO_FIRST_SLIDE__
	#endif
#endif
...
#if (defined(__OP01__))
	#ifndef __MMI_MMS_BGSR_PROMPT_SEND_RESULT__
	#define __MMI_MMS_BGSR_PROMPT_SEND_RESULT__
	#endif
#endif
...
#if (defined(__MMI_MMS_2__) && !defined(__MMI_SLIM_MMS_2__) && defined(__OP11__))
	#ifndef __MMI_MMS_GROUP_MSG__
	#define __MMI_MMS_GROUP_MSG__
	#endif
#endif


#if (defined(__OP12__) && defined(__MMI_MMS_2__) && !defined(__MMI_SLIM_MMS_2__))
	#ifndef __MMI_MMS_HIDE_SENDER_SUPPORT__
	#define __MMI_MMS_HIDE_SENDER_SUPPORT__
	#endif
#endif
...
#if (defined(__OP11__) && defined(__MMI_MMS_2__) && !defined(__MMI_SLIM_MMS_2__))
	#ifndef __MMI_MMS_MV_SUPPORT_PARAM_OF_REGION__
	#define __MMI_MMS_MV_SUPPORT_PARAM_OF_REGION__
	#endif
#endif
...
#if (defined(__MMI_UNIFIED_COMPOSER__)  && !defined(__MMI_FTE_SUPPORT__) && defined(__OP12__))
	#ifndef __MMI_MMS_POSTCARD__
	#define __MMI_MMS_POSTCARD__
	#endif
#endif
...
#if (defined(__OP12__) && defined(__MMI_MMS_2__))
	#ifndef __MMI_MMS_ROAMING_NO_ACCEPT_SUPPORT__
	#define __MMI_MMS_ROAMING_NO_ACCEPT_SUPPORT__
	#endif
#endif
...
#if (defined(__MMI_MMS_2__) && !defined(__MMI_DUAL_SIM__) && (defined(__OP11__) || defined(__OP12__)) &&  !defined(__MMI_MMS_DUAL_SIM__))
	#ifndef __MMI_MMS_SIM_USER_PREFERENCE_SUPPORT__
	#define __MMI_MMS_SIM_USER_PREFERENCE_SUPPORT__
	#endif
#endif
...
#if (defined(__OP12__) && defined(__MMI_MMS_2__) && !defined(__MMI_MMS2_MV_MANUAL_PLAY__) && !defined(__MMI_SLIM_MMS_2__))
	#ifndef __MMI_MMS_VOICE_MESSAGE_HANDLING__
	#define __MMI_MMS_VOICE_MESSAGE_HANDLING__
	#endif
#endif
...
#if (((defined(__OP01__) && !defined(__OP01_FWPBW__)) || defined(__OP02__)) && defined(__PLUTO_MMI_PACKAGE__))
	#ifndef __MMI_MOBILE_SERVICE__
	#define __MMI_MOBILE_SERVICE__
	#endif
#endif
...
#if defined(CFG_MMI_MRE_APP_KKFUN_APPSTORE_SHORTCUT) && ((CFG_MMI_MRE_APP_KKFUN_APPSTORE_SHORTCUT == __ON__)||(CFG_MMI_MRE_APP_KKFUN_APPSTORE_SHORTCUT == __AUTO__))
	#ifndef __MMI_MRE_APP_KKFUN_APPSTORE_SHORTCUT__
	#define __MMI_MRE_APP_KKFUN_APPSTORE_SHORTCUT__
	#endif
#endif
...
#if (defined(CFG_MMI_MRE_APP_MITAKE_MSTOCK)) &&\
	 (defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__) || defined(__MMI_MAINLCD_480X800__))
	#ifndef __MMI_MRE_APP_MITAKE_MSTOCK__
	#define __MMI_MRE_APP_MITAKE_MSTOCK__	CFG_MMI_MRE_APP_MITAKE_MSTOCK
	#endif
#endif
...
#if defined(CFG_MMI_MRE_APP_MTONE_APPSTORE_SHORTCUT) && ((CFG_MMI_MRE_APP_MTONE_APPSTORE_SHORTCUT == __ON__)||(CFG_MMI_MRE_APP_MTONE_APPSTORE_SHORTCUT == __AUTO__)) && \
	((defined(__MRE_CUST_MEM_SIZE__) && (__MRE_CUST_MEM_SIZE__ >= 2500)) || (!defined(__MRE_CUST_MEM_SIZE__) && (MRE_SYS_MEMORY_SIZE >= 2500)))
	#ifndef __MMI_MRE_APP_MTONE_APPSTORE_SHORTCUT__
	#define __MMI_MRE_APP_MTONE_APPSTORE_SHORTCUT__
	#endif
#endif
...
#if defined(CFG_MMI_MRE_APP_QQ2010) && ((CFG_MMI_MRE_APP_QQ2010 == __ON__)||(CFG_MMI_MRE_APP_QQ2010 == __AUTO__))
	#ifndef __MMI_MRE_APP_QQ2010__
	#define __MMI_MRE_APP_QQ2010__
	#endif
#endif


#if defined(CFG_MMI_MRE_APP_QQBROWSER) && ((CFG_MMI_MRE_APP_QQBROWSER == __ON__)||(CFG_MMI_MRE_APP_QQBROWSER == __AUTO__))
	#ifndef __MMI_MRE_APP_QQBROWSER__
	#define __MMI_MRE_APP_QQBROWSER__
	#endif
#endif


#if defined(CFG_MMI_MRE_APP_RENREN) && ((CFG_MMI_MRE_APP_RENREN == __ON__)||(CFG_MMI_MRE_APP_RENREN == __AUTO__)) && \
	(!defined(__MRE_PACKAGE_SLIM__) && (defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__) || defined(__MMI_MAINLCD_480X800__)))
	#ifndef __MMI_MRE_APP_RENREN__
	#define __MMI_MRE_APP_RENREN__
	#endif
#endif
...
#if (defined(CFG_MMI_MRE_APP_VOGINS_MOBILE_MARKET)) &&\
	 (defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X480__))
	#ifndef __MMI_MRE_APP_VOGINS_MOBILE_MARKET__
	#define __MMI_MRE_APP_VOGINS_MOBILE_MARKET__	CFG_MMI_MRE_APP_VOGINS_MOBILE_MARKET
	#endif
#endif
	...
	#if (defined(__MRE_PACKAGE_SLIM__) || !defined(PNG_DECODE))
	#error "Yahoo Cricket application cannot execute without PNG_DECODE or HTTP(HTTP is not supported in MRE SLIM package)"
	#endif
	...
	#error "Yahoo Finance application cannot execute without HTTP, HTTP is not supported in MRE SLIM package"
	#endif
...
#if defined(CFG_MMI_MRE_APP_YAHOOMV1) && ((CFG_MMI_MRE_APP_YAHOOMV1 == __ON__)||(CFG_MMI_MRE_APP_YAHOOMV1 == __AUTO__)) && \
	(defined(__YAHOO_CONTENT_SUPPORT__) && (!defined(__MMI_MRE_APP_YAHOOMV2__)) && (!defined(__MMI_MAINLCD_128X128__)))
	#ifndef __MMI_MRE_APP_YAHOOMV1__
	#define __MMI_MRE_APP_YAHOOMV1__
	#endif
#endif
	...
	(defined(__YAHOO_CONTENT_SUPPORT__))
	#if (defined(__MRE_PACKAGE_SLIM__))
	#error "ahoo News application cannot execute without HTTP, HTTP is not supported in MRE SLIM package"
	#endif
	...
	(defined(__YAHOO_CONTENT_SUPPORT__))
	#if (defined(__MRE_PACKAGE_SLIM__))
	#error "Yahoo Weather application cannot execute without HTTP, HTTP is not supported in MRE SLIM package"
	#endif
	...
	#define __MMI_MRE_APP_YOUTUBE__
	#endif
#endif
...
#if defined(CFG_MMI_MRE_SHORTCUT_QQ) && ((CFG_MMI_MRE_SHORTCUT_QQ == __ON__)||(CFG_MMI_MRE_SHORTCUT_QQ == __AUTO__)) && \
	(!defined(__MMI_MAINLCD_480X800__))
	#ifndef __MMI_MRE_SHORTCUT_QQ__
	#define __MMI_MRE_SHORTCUT_QQ__
	#endif
#endif
...
#if (defined(__MMI_MULTITAP__) && defined(__MMI_LANG_MYANMAR__))
...
#if (defined(__OP01__))
	#ifndef __MMI_OP01_MY_FAVORITE__
	#define __MMI_OP01_MY_FAVORITE__
	#endif
#endif


#if (defined(__OP02__))
	#ifndef __MMI_OP02_MY_FAVORITE__
	#define __MMI_OP02_MY_FAVORITE__
	#endif
#endif


#if (defined(__OP11__))
	#ifndef __MMI_OP11_MY_FAVORITE__
	#define __MMI_OP11_MY_FAVORITE__
	#endif
#endif


#if (defined(__OP12__))
	#ifndef __MMI_OP12_MY_FAVORITE__
	#define __MMI_OP12_MY_FAVORITE__
	#endif
#endif


#if (((defined(__MMI_OP01_MY_FAVORITE__) && !defined(__OP01_FWPBW__)) || defined(__MMI_OP02_MY_FAVORITE__) || defined(__MMI_OP11_MY_FAVORITE__) || defined(__MMI_OP12_MY_FAVORITE__)) && defined(__PLUTO_MMI_PACKAGE__))
	#ifndef __MMI_MY_FAVORITE__
	#define __MMI_MY_FAVORITE__
	#endif
#endif
...
#if ((defined(__OP02__)||defined(__OP01__)) && defined(__MMI_MMS_2__))
	#ifndef __MMI_OP01_202_MMS_REPLY_BY_SMS_MMS_SUPPORT__
	#define __MMI_OP01_202_MMS_REPLY_BY_SMS_MMS_SUPPORT__
	#endif
#endif


#if (defined(__OP01__))
	#ifndef __MMI_OP01_CSD_DATACFG__
	#define __MMI_OP01_CSD_DATACFG__
	#endif
#endif


#if (defined(__OP01__) && defined(DCD_INFRAWARE) && defined(__DCD_V20__))
	#ifndef __MMI_OP01_DCD__
	#define __MMI_OP01_DCD__
	#endif
#endif


#if (defined(__OP01__) && defined(DCD_INFRAWARE) && defined(__DCD_V30__))
	#ifndef __MMI_OP01_DCD_V30__
	#define __MMI_OP01_DCD_V30__
	#endif
#endif


#if (defined(__OP01__) && defined(SYNCML_DM_SUPPORT) && defined(__MMI_MOBILE_SERVICE__))
...
/* under construction !*/
...
#if (defined(__OP01__) && defined(__OP01_GPRS_DATACFG__))
	#ifndef __MMI_OP01_GPRS_DATACFG__
	#define __MMI_OP01_GPRS_DATACFG__
	#endif
#endif


#if (defined(__OP01__))
	#ifndef __MMI_OP01_INPUT_METHOD_DATACFG__
	#define __MMI_OP01_INPUT_METHOD_DATACFG__
	#endif
#endif


#if (defined(__OP01__) && defined(__MMI_MAINLCD_240X400__))
	#ifndef __MMI_OP01_MENU_12MATRIX__
	#define __MMI_OP01_MENU_12MATRIX__
	#endif
#endif
	...
	#define __MMI_OP01_MENU_9MATRIX__
	#endif
#endif


#if (defined(__OP01__))
	#ifndef __MMI_OP01_MENU_NOSIM_LIST__
	#define __MMI_OP01_MENU_NOSIM_LIST__
	#endif
#endif


#if defined(CFG_MMI_OP01_MIDLET_139MAIL) && ((CFG_MMI_OP01_MIDLET_139MAIL == __ON__)||(CFG_MMI_OP01_MIDLET_139MAIL == __AUTO__)) && \
	(defined(__OP01__)  &&  defined(__J2ME__))
	#ifndef __MMI_OP01_MIDLET_139MAIL__
	#define __MMI_OP01_MIDLET_139MAIL__
	#endif
#endif


#if defined(CFG_MMI_OP01_MIDLET_CMREAD) && ((CFG_MMI_OP01_MIDLET_CMREAD == __ON__)||(CFG_MMI_OP01_MIDLET_CMREAD == __AUTO__)) && \
	(defined(__OP01__)  &&  defined(__J2ME__))
	#ifndef __MMI_OP01_MIDLET_CMREAD__
	#define __MMI_OP01_MIDLET_CMREAD__
	#endif
#endif


#if defined(CFG_MMI_OP01_MIDLET_FETION) && ((CFG_MMI_OP01_MIDLET_FETION == __ON__)||(CFG_MMI_OP01_MIDLET_FETION == __AUTO__)) && \
	(defined(__OP01__)  &&  defined(__J2ME__))
	#ifndef __MMI_OP01_MIDLET_FETION__
	#define __MMI_OP01_MIDLET_FETION__
	#endif
#endif


#if defined(CFG_MMI_OP01_MIDLET_MOBILE_GAME) && ((CFG_MMI_OP01_MIDLET_MOBILE_GAME == __ON__)||(CFG_MMI_OP01_MIDLET_MOBILE_GAME == __AUTO__)) && \
	(defined(__OP01__)  &&  defined(__J2ME__))
	#ifndef __MMI_OP01_MIDLET_MOBILE_GAME__
	#define __MMI_OP01_MIDLET_MOBILE_GAME__
	#endif
#endif


#if defined(CFG_MMI_OP01_MIDLET_MOBILE_MARKET) && ((CFG_MMI_OP01_MIDLET_MOBILE_MARKET == __ON__)||(CFG_MMI_OP01_MIDLET_MOBILE_MARKET == __AUTO__)) && \
	(defined(__OP01__)  &&  defined(__J2ME__))
	#ifndef __MMI_OP01_MIDLET_MOBILE_MARKET__
	#define __MMI_OP01_MIDLET_MOBILE_MARKET__
	#endif
#endif


#if defined(CFG_MMI_OP01_MIDLET_MOBILE_STOCK) && ((CFG_MMI_OP01_MIDLET_MOBILE_STOCK == __ON__)||(CFG_MMI_OP01_MIDLET_MOBILE_STOCK == __AUTO__)) && \
	(defined(__OP01__)  &&  defined(__J2ME__))
	#ifndef __MMI_OP01_MIDLET_MOBILE_STOCK__
	#define __MMI_OP01_MIDLET_MOBILE_STOCK__
	#endif
#endif


#if defined(CFG_MMI_OP01_MIDLET_MUSIC_WALKMAN) && ((CFG_MMI_OP01_MIDLET_MUSIC_WALKMAN == __ON__)||(CFG_MMI_OP01_MIDLET_MUSIC_WALKMAN == __AUTO__)) && \
	(defined(__OP01__)  &&  defined(__J2ME__))
	#ifndef __MMI_OP01_MIDLET_MUSIC_WALKMAN__
	#define __MMI_OP01_MIDLET_MUSIC_WALKMAN__
	#endif
#endif


#if (defined(__MMI_MMS_2__) && defined(__OP01__))
	#ifndef __MMI_OP01_MMS_ADD_SLIDE_TIME_FOR_MIXED_MMS_SUPPORT__
	#define __MMI_OP01_MMS_ADD_SLIDE_TIME_FOR_MIXED_MMS_SUPPORT__
	#endif
#endif


#if (defined(__OP01__) && defined(__SYNCML_SUPPORT__) && defined(__MMI_MOBILE_SERVICE__))
...
#if defined(CFG_MMI_OP01_WIFI) && ((CFG_MMI_OP01_WIFI == __ON__)||(CFG_MMI_OP01_WIFI == __AUTO__)) && \
	(defined(__OP01__) && defined(__WIFI_SUPPORT__) && defined(__MMI_WLAN_FEATURES__))
	#ifndef __MMI_OP01_WIFI__
	#define __MMI_OP01_WIFI__
	#endif
#endif
...
#if (defined(__OP01__) && defined(BROWSER_SUPPORT) && defined (__MMI_WITH_WAP_KEY__))
	#ifndef __MMI_OP01_WITH_WAP_KEY__
	#define __MMI_OP01_WITH_WAP_KEY__
	#endif
#endif


#if (defined(__OP02__) && defined(__PLUTO_MMI_PACKAGE__))
	#ifndef __MMI_OP02_0100__
	#define __MMI_OP02_0100__
	#endif
#endif


#if defined(CFG_MMI_OP02_LEMEI) && ((CFG_MMI_OP02_LEMEI == __ON__)||(CFG_MMI_OP02_LEMEI == __AUTO__))
	#ifndef __MMI_OP02_LEMEI__
	#define __MMI_OP02_LEMEI__
	#endif
#endif


#if defined(CFG_MMI_OP02_LEMEI_FTO) && ((CFG_MMI_OP02_LEMEI_FTO == __ON__)||(CFG_MMI_OP02_LEMEI_FTO == __AUTO__))
	#ifndef __MMI_OP02_LEMEI_FTO__
	#define __MMI_OP02_LEMEI_FTO__
	#endif
#endif


#if (defined(__MMI_VERSION_2__) && defined(__OP02__) && defined(__PLUTO_MMI_PACKAGE__))
	#ifndef __MMI_OP02_MAINMENU_12MATRIX__
	#define __MMI_OP02_MAINMENU_12MATRIX__
	#endif
#endif


#if (!defined(__MMI_VERSION_2__) && defined(__OP02__) && defined(__PLUTO_MMI_PACKAGE__))
	#ifndef __MMI_OP02_MAINMENU_9MATRIX__
	#define __MMI_OP02_MAINMENU_9MATRIX__
	#endif
#endif


#if defined(CFG_MMI_OP02_MIDLET_116114) && ((CFG_MMI_OP02_MIDLET_116114 == __ON__)||(CFG_MMI_OP02_MIDLET_116114 == __AUTO__))
	#ifndef __MMI_OP02_MIDLET_116114__
	#define __MMI_OP02_MIDLET_116114__
	#endif
#endif


#if defined(CFG_MMI_OP02_MIDLET_MOBILE_MUSIC) && ((CFG_MMI_OP02_MIDLET_MOBILE_MUSIC == __ON__)||(CFG_MMI_OP02_MIDLET_MOBILE_MUSIC == __AUTO__))
	#ifndef __MMI_OP02_MIDLET_MOBILE_MUSIC__
	#define __MMI_OP02_MIDLET_MOBILE_MUSIC__
	#endif
#endif


#if defined(CFG_MMI_OP02_MIDLET_MOBILE_TV) && ((CFG_MMI_OP02_MIDLET_MOBILE_TV == __ON__)||(CFG_MMI_OP02_MIDLET_MOBILE_TV == __AUTO__))
	#ifndef __MMI_OP02_MIDLET_MOBILE_TV__
	#define __MMI_OP02_MIDLET_MOBILE_TV__
	#endif
#endif


#if defined(CFG_MMI_OP02_MIDLET_PUSH_MAIL) && ((CFG_MMI_OP02_MIDLET_PUSH_MAIL == __ON__)||(CFG_MMI_OP02_MIDLET_PUSH_MAIL == __AUTO__))
	#ifndef __MMI_OP02_MIDLET_PUSH_MAIL__
	#define __MMI_OP02_MIDLET_PUSH_MAIL__
	#endif
#endif


#if defined(CFG_MMI_OP02_MIDLET_WO_STORE) && ((CFG_MMI_OP02_MIDLET_WO_STORE == __ON__)||(CFG_MMI_OP02_MIDLET_WO_STORE == __AUTO__))
	#ifndef __MMI_OP02_MIDLET_WO_STORE__
	#define __MMI_OP02_MIDLET_WO_STORE__
	#endif
#endif


#if (defined(__OP02__) && defined(BROWSER_SUPPORT) && defined (__MMI_WITH_WAP_KEY__))
	#ifndef __MMI_OP02_WITH_WAP_KEY__
	#define __MMI_OP02_WITH_WAP_KEY__
	#endif
#endif


#if defined(CFG_MMI_OP02_WO_PORTAL) && ((CFG_MMI_OP02_WO_PORTAL == __ON__)||(CFG_MMI_OP02_WO_PORTAL == __AUTO__)) && \
	(defined(OPERA_BROWSER) && defined(__OP02__))
	#ifndef __MMI_OP02_WO_PORTAL__
	#define __MMI_OP02_WO_PORTAL__
	#endif
#endif


#if (defined(__OP11__))
	#ifndef __MMI_OP11_BOOTUP_PROGRESS_BAR_IN_OP_COLOR__
	#define __MMI_OP11_BOOTUP_PROGRESS_BAR_IN_OP_COLOR__
	#endif
#endif


#if (defined(__MMI_CAMERA__) && defined(__MMI_VIDEO_RECORDER__) && defined(__OP11__))
	#ifndef __MMI_OP11_CAMERA_VDOREC_CUSTOMIZE__
	#define __MMI_OP11_CAMERA_VDOREC_CUSTOMIZE__
	#endif
#endif


#if (defined (__MMI_IMPS__) && defined (__OP11__))
...
/* under construction !*/
...
#if (defined(__OP11__))
	#ifndef __MMI_OP11_MENU_12MATRIX__
	#define __MMI_OP11_MENU_12MATRIX__
	#endif
#endif


#if (defined(__OP11__))
	#ifndef __MMI_OP11_MMS_SEND_TO_PHOTO_BLOG__
	#define __MMI_OP11_MMS_SEND_TO_PHOTO_BLOG__
	#endif
#endif
	...
	#define __MMI_OP11_MMS_SUPPORT_AUDIO_MSG__
	#endif
#endif


#if (defined(__OP11__))
	#ifndef __MMI_OP11_MMS_SUPPORT_PHOTO_MSG__
	#define __MMI_OP11_MMS_SUPPORT_PHOTO_MSG__
	#endif
#endif


#if (defined(__OP11__))
	#ifndef __MMI_OP11_MMS_SUPPORT_VIDEO_MSG__
	#define __MMI_OP11_MMS_SUPPORT_VIDEO_MSG__
	#endif
#endif


#if (defined(__OP11__))
	#ifndef __MMI_OP11_PROF_SOUND__
	#define __MMI_OP11_PROF_SOUND__
	#endif
#endif


#if (defined(__OP11__))
	#ifndef __MMI_OP11_SIDEBAR__
	#define __MMI_OP11_SIDEBAR__
	#endif
#endif


#if (defined(__OP11__) && defined(__SYNCML_SUPPORT__) && defined(__MMI_MOBILE_SERVICE__))
	#ifndef __MMI_OP11_SYNCML_SETTING__
/* under construction !*/
	#endif
#endif
	...
	#define __MMI_OP11_TAB_BAR__
	#endif
#endif


#if (defined(__OP11__))
	#ifndef __MMI_OP11_TODOLIST_DIARY_SUPPORT__
	#define __MMI_OP11_TODOLIST_DIARY_SUPPORT__
	#endif
#endif


#if (defined(__OP12__) && defined(OBIGO_Q05A))
	#ifndef __MMI_OP12_AUD_APPLY_PROFILE__
	#define __MMI_OP12_AUD_APPLY_PROFILE__
	#endif
#endif


#if (defined(__MMI_BROWSER_2__) && defined(__OP12__))
	#ifndef __MMI_OP12_BRW_CLEAR_DATA_ON_SIM_CHANGE__
	#define __MMI_OP12_BRW_CLEAR_DATA_ON_SIM_CHANGE__
	#endif
#endif
	...
	#define __MMI_OP12_BRW_DEFAULT_BOOKMARKS_EDITABLE__
	#endif
#endif


#if (defined(__MMI_BROWSER_2__) && defined(__OP12__))
	#ifndef __MMI_OP12_BRW_EMBEDDED_LINKS__
	#define __MMI_OP12_BRW_EMBEDDED_LINKS__
	#endif
#endif


#if (defined(__MMI_BROWSER_2__) && defined(__OP12__))
	#ifndef __MMI_OP12_BRW_SEARCH_MENU__
	#define __MMI_OP12_BRW_SEARCH_MENU__
	#endif
#endif


#if (defined(__MMI_CAMERA__) && defined(__MMI_VIDEO_RECORDER__) && defined(__OP12__))
	#ifndef __MMI_OP12_CAMERA_VDOREC_CUSTOMIZE__
	#define __MMI_OP12_CAMERA_VDOREC_CUSTOMIZE__
	#endif
#endif


#if (defined(__OP12__) && defined(SYNCML_DM_SUPPORT))
	#ifndef __MMI_OP12_DM_PROFILE_SETTING__
	#define __MMI_OP12_DM_PROFILE_SETTING__
	#endif
#endif
	...
	#define __MMI_OP12_MENU_12MATRIX__
	#endif
#endif


#if (defined(__OP12__))
	#ifndef __MMI_OP12_MESSAGE_CB__
	#define __MMI_OP12_MESSAGE_CB__
	#endif
#endif


#if (defined(__OP12__))
	#ifndef __MMI_OP12_MESSAGE_VOICEMAIL__
	#define __MMI_OP12_MESSAGE_VOICEMAIL__
	#endif
#endif


#if (defined(__MMI_OP12_TOOLBAR__))
	#ifndef __MMI_OP12_MESSAGE_VOICEMAIL_PLUGIN__
	#define __MMI_OP12_MESSAGE_VOICEMAIL_PLUGIN__
	#endif
#endif


#if (defined(__MMI_MMS_2__) && defined(__OP12__))
	#ifndef __MMI_OP12_MMS_GROUP_MSG_SUPPORT__
	#define __MMI_OP12_MMS_GROUP_MSG_SUPPORT__
	#endif
#endif
...
#if (defined(MMS_SUPPORT) && defined(__OP12__))
	#ifndef __OP12_MMS_CONTENT_CLASS_IMAGE_RESOLUTION_CHECK_OFF__
	#define __OP12_MMS_CONTENT_CLASS_IMAGE_RESOLUTION_CHECK_OFF__
	#endif
#endif
...
#if (defined(__OP12__) && defined(OBIGO_Q03C_MMS_V02))
	#ifndef __MMI_OP12_MMS_SUPPORT_NO_DEFAULT_VALUE_IN_PDU__
	#define __MMI_OP12_MMS_SUPPORT_NO_DEFAULT_VALUE_IN_PDU__
	#endif
#endif
	...
	#define __MMI_OP12_MMS_SUPPORT_SETTINGS__
	#endif
#endif


#if (defined(__OP12__))
	#ifndef __MMI_OP12_PHB__
	#define __MMI_OP12_PHB__
	#endif
#endif


#if (defined(__OP12__))
	#ifndef __MMI_OP12_SCROLLBAR_STYLE__
	#define __MMI_OP12_SCROLLBAR_STYLE__
	#endif
#endif


#if (defined(__OP12__) && defined(__MMI_MAINLCD_240X320__))
	#ifndef __MMI_OP12_SNDREC_STYLE__
	#define __MMI_OP12_SNDREC_STYLE__
	#endif
#endif


#if (defined(__OP12__))
	#ifndef __MMI_OP12_SS_ERR_MSG__
	#define __MMI_OP12_SS_ERR_MSG__
	#endif
#endif
...
#if defined(CFG_MMI_PHB_ALS_SUPPORT) && ((CFG_MMI_PHB_ALS_SUPPORT == __ON__)||(CFG_MMI_PHB_ALS_SUPPORT == __AUTO__))
...
#if defined(CFG_MMI_PHB_ECC_DIRECT_DIAL) && ((CFG_MMI_PHB_ECC_DIRECT_DIAL == __ON__)||(CFG_MMI_PHB_ECC_DIRECT_DIAL == __AUTO__))
...
#if defined(CFG_MMI_PHB_USIM_GROUP_SUPPORT) && ((CFG_MMI_PHB_USIM_GROUP_SUPPORT == __ON__)||(CFG_MMI_PHB_USIM_GROUP_SUPPORT == __AUTO__)) && \
	(defined(__MMI_PHB_USIM_SUPPORT__))
...
#if defined(CFG_MMI_PHB_SIM_NUMBER_MANAGEMENT) && ((CFG_MMI_PHB_SIM_NUMBER_MANAGEMENT == __ON__)||(CFG_MMI_PHB_SIM_NUMBER_MANAGEMENT == __AUTO__))
...
#if defined(CFG_MMI_PHB_SLIM) && ((CFG_MMI_PHB_SLIM == __ON__)||(CFG_MMI_PHB_SLIM == __AUTO__))
	...
	(!defined(__LOW_COST_SUPPORT_COMMON__) || defined(__MMI_MAINLCD_96X64__ ))	//xb add 2016-09-02 ���ػ�����
	...
	#define __MMI_PROF_BEEP_WHEN_BGPLAYING__
	#endif
#endif


#if (defined(__OP12__))
	#ifndef __MMI_PROF_MUTE_APP_ON_SILENT_MODE__
	#define __MMI_PROF_MUTE_APP_ON_SILENT_MODE__
	#endif
#endif
...
#if (defined(__UM_FOLDER__) && defined(BROWSER_SUPPORT))
	...
	(defined(WAP_SUPPORT)&&!defined(__SLIM_PUSH_FEATURE_SUPPORT))
...
/* 20260423 */
#if (defined(__MATERIAL_UI_THEME_MODIFY_THEMERES__))
#if ((defined(__MMI_RES_TYPE_WALLPAPER_SEL__) && (__MMI_RES_TYPE_WALLPAPER_SEL__ == __RES_TYPE_JPG__)))
...
#endif
#else
#if (((!defined(__MMI_FWUI_SLIM__)) && ((defined(__MMI_RES_TYPE_WALLPAPER_SEL__) && (__MMI_RES_TYPE_WALLPAPER_SEL__ == __RES_TYPE_BMP__)) || (defined(__MMI_VUI_LAUNCHER_KEY__)) || ((defined(__CPU_ARM7EJ_S__) && !defined(__COSMOS_MMI_PACKAGE__) && (defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X240__)))))))
	#ifndef __MMI_RES_TYPE_WALLPAPER__
	#define __MMI_RES_TYPE_WALLPAPER__	"BMP"
	#endif
...
/* 20260423 */
	...
	((!(defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__)|| defined(__MMI_MAINLCD_128X36__)|| defined(__MMI_MAINLCD_128X64__)) && (defined(HORIZONTAL_CAMERA) || (defined(JPG_DECODE) && (!defined(HORIZONTAL_CAMERA) && (defined(__MMI_IMAGE_VIEWER_STD__) ||  defined(__MMI_IMAGE_VIEWER_EX__) || defined(__MMI_SLIDESHOW__)))))) || (!(defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__)) && (defined(HORIZONTAL_CAMERA))) || defined(__COSMOS_MMI__))
...
#if (defined(__MMI_SEARCH_WEB_BAIDU__) || defined(__MMI_SEARCH_WEB_GOOGLE__)|| defined(__MMI_GB_WINGUO__))
...
#if defined(CFG_MMI_SEPARATE_DT_SETTING) && ((CFG_MMI_SEPARATE_DT_SETTING == __ON__)||(CFG_MMI_SEPARATE_DT_SETTING == __AUTO__))
...
#if (defined(__OP12__))
	#ifndef __MMI_SETTING_APP_SETUP__
	#define __MMI_SETTING_APP_SETUP__
	#endif
#endif
...
#if (defined( __MMI_OP11_HOMESCREEN_0301__) || defined(__MMI_OP11_HOMESCREEN_0302__))
	#ifndef __MMI_SMS_FOR_HOMESCREEN__
	#define __MMI_SMS_FOR_HOMESCREEN__
	#endif
#endif
...
#if defined(CFG_MMI_TIMEZONE_CHANGE_DATETIME) && ((CFG_MMI_TIMEZONE_CHANGE_DATETIME == __ON__)||(CFG_MMI_TIMEZONE_CHANGE_DATETIME == __AUTO__))
...
#if defined(CFG_MMI_TODO_SEARCH) && ((CFG_MMI_TODO_SEARCH == __ON__)||(CFG_MMI_TODO_SEARCH == __AUTO__)) && \
	(defined(__MMI_TODOLIST__))
...
#if defined(CFG_MMI_UC_REF) && ((CFG_MMI_UC_REF == __ON__)||(CFG_MMI_UC_REF == __AUTO__)) && \
	(defined(__MMI_MMS_2__) && (defined(__MMI_UNIFIED_COMPOSER__) || defined(__MMI_MMS_STANDALONE_COMPOSER__)) && !defined(__MMI_SLIM_MMS_2__))
	#ifndef __MMI_UC_REF__
	#define __MMI_UC_REF__
	#endif
#endif
...
#if defined(CFG_MMI_UCM_DISPLAY_NAME_ON_CALL_END) && ((CFG_MMI_UCM_DISPLAY_NAME_ON_CALL_END == __ON__)||(CFG_MMI_UCM_DISPLAY_NAME_ON_CALL_END == __AUTO__)) && \
	(defined(__OP12__))
	#ifndef __MMI_UCM_DISPLAY_NAME_ON_CALL_END__
	#define __MMI_UCM_DISPLAY_NAME_ON_CALL_END__
	#endif
#endif
...
#define __MMI_UI_STATUSBAR_STYLE__	STATUSBAR_STYLE_NONE
	...
	#ifndef __MMI_UM_FILTER_BY_SIM_SUPPORT__
	#define __MMI_UM_FILTER_BY_SIM_SUPPORT__
	#endif
#endif
...
#if (defined(__DT_SUPPORT__) && defined(__MMI_MMS_2__))
...
/* under construction !*/
...
#if (defined(__OP01__))
	#ifndef __MMI_VERSION_INFO__
	#define __MMI_VERSION_INFO__
	#endif
#endif
	...
	#define __MMI_VIDEO_PDL_YOUTUBE__
	#endif
#endif
...
#if defined(CFG_MMI_VIEW_SETTING_DISABLE_CACHE) && ((CFG_MMI_VIEW_SETTING_DISABLE_CACHE == __ON__)||(CFG_MMI_VIEW_SETTING_DISABLE_CACHE == __AUTO__))
...
#if (defined(WAP_SUPPORT) && defined(__SLIM_PUSH_FEATURE_SUPPORT__) && defined(__PLUTO_MMI_PACKAGE__))
...
#if (defined(WAP_SUPPORT) && defined(__MMI_WAP_PUSH_WHITE_LIST__) && defined(__FULL_PUSH_FEATURE_SUPPORT__))
...
#if defined(CFG_MMI_WLAN_WPS) && ((CFG_MMI_WLAN_WPS == __ON__)||(CFG_MMI_WLAN_WPS == __AUTO__)) && \
	(defined(__WPS_SUPPORT__) && !defined(__WIFI_SUPPORT__))
	#ifndef __MMI_WLAN_WPS__
	#define __MMI_WLAN_WPS__
	#endif
#endif
	...
	#define __MMI_YOUTUBE_SHORTCUT__
	#endif
#endif


#if (defined(__MMI_MMS_2__) && defined(__OP11__))
	#ifndef __OP11_MMS_HIDE_ROOTLAYOUT_WIDTH_HEIGHT__
	#define __OP11_MMS_HIDE_ROOTLAYOUT_WIDTH_HEIGHT__
	#endif
#endif


#if (defined(__OP11__))
	#ifndef __OP11_PRESET_ROOT_CERTS__
	#define __OP11_PRESET_ROOT_CERTS__
	#endif
#endif
...
#if (defined(__SRV_SMS_BACKGROUND_SEND_SUPPORT__) && defined(__OP01__))
	#ifndef __SRV_SMS_BACKGROUND_AUTO_RESEND_SUPPORT__
	#define __SRV_SMS_BACKGROUND_AUTO_RESEND_SUPPORT__
	#endif
#endif
...
#if (defined(__UI_MMS_VIEWER_CATEGORY__) || defined(__MMI_EBOOK_READER__) || defined(__MMI_MOBILE_TV_CMMB_SUPPORT__))
...
#if (defined(__OP01__))
	#ifndef __WIDGET_SCROLLBAR_INDICATION_IN_BROWSER__
	#define __WIDGET_SCROLLBAR_INDICATION_IN_BROWSER__
	#endif
#endif
...
#if (!defined(__MMI_FWUI_SLIM__) && !defined(__MATERIAL_UI_THEME_MODIFY_IDLE__))
