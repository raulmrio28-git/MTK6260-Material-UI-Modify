...
/*20260423*/
                    #ifdef __MATERIAL_UI_THEME_MODIFY_IDLE__
                    wgui_clock_set_digital_align_type(wgui_clock_mainlcd_clock1, GUI_CLOCK_DIGITAL_ALIGN_RIGHT);
                    #else
...
/*20260423*/
                    #ifdef __MATERIAL_UI_THEME_MODIFY_IDLE__
                    {
                        extern S32 g_gui_clock_matui_h;
                        extern S32 g_gui_clock_matui_m;
                        extern kal_bool g_gui_clock_matui_is_ampm;
                        extern S32 g_gui_clock_matui_ampm_mode;
                        MYTIME default_time;
						memset(&default_time, 0, sizeof(MYTIME));
                        GetDateTime(&default_time);
                        g_gui_clock_matui_h = default_time.nHour;
						g_gui_clock_matui_m = default_time.nMin;
                        g_gui_clock_matui_is_ampm = (PhnsetGetTimeFormat() == 0) ? KAL_TRUE : KAL_FALSE;
                        if (g_gui_clock_matui_is_ampm)
                            g_gui_clock_matui_ampm_mode = (g_gui_clock_matui_h >= 12) ? 1 : 0;
                        wgui_clock_measure_digital_clock(wgui_clock_mainlcd_clock1, &w, &h);
                        time_w = w;
                        time_h = h;
                    }
...
/*20260423*/
                #elif defined(__MATERIAL_UI_THEME_MODIFY_IDLE__)
                    x = MAIN_LCD_DEVICE_WIDTH-time_w-MATUI_TIME_BORDER_X;
                    y = MMI_STATUS_BAR_HEIGHT+MATUI_TIME_BORDER_Y;
/*20260423*/
                #else /* __MMI_UI_TECHNO_IDLESCREEN_BAR__ */
...
/*20260423*/
                #ifndef __MATERIAL_UI_THEME_MODIFY_IDLE__
                    w += 2;
                #endif
/*20260423*/        
                #endif
...
/*20260423*/
        #elif defined(__MATERIAL_UI_THEME_MODIFY_IDLE__)
            x = MAIN_LCD_DEVICE_WIDTH-w-MATUI_TIME_BORDER_X;
            y = MMI_STATUS_BAR_HEIGHT+time_h+MATUI_TIME_BORDER_Y+MATUI_TIME_DATE_BORDER_H;
/*20260423*/
        #else /* __MMI_UI_TECHNO_IDLESCREEN_BAR__ */ 
