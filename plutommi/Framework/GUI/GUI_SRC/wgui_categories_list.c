...
/* 20260424 */
    ...
    if ((act_layer != src_layer) && src_layer)
        gdi_effect_alpha_blending_rect(src_layer, MMI_title_x, MMI_title_y, MMI_title_x + MMI_title_width - 1, MMI_title_y + MMI_title_height - 1, 128, 0, 0, 0);
    else if (act_layer)
        gdi_effect_alpha_blending_rect(act_layer, MMI_title_x, MMI_title_y, MMI_title_x + MMI_title_width - 1, MMI_title_y + MMI_title_height - 1, 255, 0, 0, 0);
    #else
...
#endif /* __MMI_FTE_SUPPORT__ */
/* 20260424 */
    #if (defined(__MMI_SLIM_IMG_RES__)||defined(__MATERIAL_UI_THEME_MODIFY_THEMERES__))
/* 20260424 */
