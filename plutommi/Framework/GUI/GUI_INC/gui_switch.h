...
/* 20260423 */
    ...
    #define CFG_UI_IDLE_NETWORK_NAME_Y_WITH_TECHNO_AND_SHORTCUT     (170)
    #define CFG_UI_IDLE_NETWORK_NAME_Y_WITH_TECHNO                  (170)
    #define CFG_UI_IDLE_NETWORK_NAME_Y_WITH_STATUS_AT_BOTTOM        (170)
    #define CFG_UI_IDLE_NETWORK_NAME_Y                              (170)
    #define CFG_UI_IDLE_NETWORK_STATUS_Y_WITH_TECHNO_AND_SHORTCUT   (198)
    #define CFG_UI_IDLE_NETWORK_STATUS_Y_WITH_TECHNO                (198)
    #define CFG_UI_IDLE_NETWORK_STATUS_Y_WITH_STATUS_AT_BOTTOM      (198)
    #define CFG_UI_IDLE_NETWORK_STATUS_Y                            (198)
    #define CFG_UI_IDLE_EXTRA_Y_WITH_TECHNO_AND_SHORTCUT            (140)
    #define CFG_UI_IDLE_EXTRA_Y_WITH_TECHNO                         (140)
    #define CFG_UI_IDLE_EXTRA_Y_WITH_STATUS_AT_BOTTOM               (140)
    #define CFG_UI_IDLE_EXTRA_Y                                     (140)
    #define CFG_UI_IDLE_SATICON_Y_WITH_TECHNO_AND_SHORTCUT          (100)
    #define CFG_UI_IDLE_SATICON_Y_WITH_TECHNO                       (100)
    #define CFG_UI_IDLE_SATICON_Y_WITH_STATUS_AT_BOTTOM             (100)
    #define CFG_UI_IDLE_SATICON_Y                                   (100)

    #define CFG_UI_IDLE_SIM2_NETWORK_NAME_Y_WITH_TECHNO_AND_SHORTCUT    (226)
    #define CFG_UI_IDLE_SIM2_NETWORK_NAME_Y_WITH_TECHNO                 (226)
    #define CFG_UI_IDLE_SIM2_NETWORK_NAME_Y_WITH_STATUS_AT_BOTTOM       (226)
    #define CFG_UI_IDLE_SIM2_NETWORK_NAME_Y                             (226)
    #define CFG_UI_IDLE_SIM2_NETWORK_STATUS_Y_WITH_TECHNO_AND_SHORTCUT  (254)    
    #define CFG_UI_IDLE_SIM2_NETWORK_STATUS_Y_WITH_TECHNO               (254)
    #define CFG_UI_IDLE_SIM2_NETWORK_STATUS_Y_WITH_STATUS_AT_BOTTOM     (254)
    #define CFG_UI_IDLE_SIM2_NETWORK_STATUS_Y                           (254)
#else
...
/* main menu matrix menuitem image width and height */
    ...
    #define CFG_UI_THIN_TITLE_HEIGHT                       (16)
    /* height of thin title */
    #define CFG_UI_THICK_TITLE_HEIGHT                      (16)
    ...
    #define CFG_UI_MENUITEM_HEIGHT                         (16)
    /* height of two-line menu item*/
    #define CFG_UI_MENUITEM_TWOLINE_HEIGHT                 (16) 
    /* height of multi-row menu item*/
    #define CFG_UI_MENUITEM_MULTIROW_HEIGHT                (16)
    /* height of thick menu item*/
    #define CFG_UI_MENUITEM_THICK_HEIGHT                   (16)
...
/* 20260422 */
    ...
    #define CFG_UI_ICON_BAR_HEIGHT                         (28)
