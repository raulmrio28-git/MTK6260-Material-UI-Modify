 ...
 *****************************************************************************/
/* 20260422 */
#ifdef __MATERIAL_UI_THEME_MODIFY_FONTRES__
#define GUI_XXSMALL_FONT_SIZE    8
#define GUI_XSMALL_FONT_SIZE    12
#define GUI_SMALL_FONT_SIZE     16
#define GUI_MEDIUM_FONT_SIZE    21
#define GUI_LARGE_FONT_SIZE     25
#define GUI_XLARGE_FONT_SIZE    28
#define GUI_XXLARGE_FONT_SIZE    34
#define GUI_XXXLARGE_FONT_SIZE   38
#else
...
/* 20260422 */
#if (defined(__MATERIAL_UI_THEME_MODIFY_FONTRES__))
const static stFontAttribute g_gui_font_oem_data [] =
{
    {0,0,0,0x80|GUI_XXSMALL_FONT_SIZE,0,1	},
    {0,0,0,0x80|GUI_XSMALL_FONT_SIZE,0,1	},
    {0,0,0,0x80|GUI_SMALL_FONT_SIZE,0,1	},
    {0,0,0,0x80|GUI_MEDIUM_FONT_SIZE,0,1	},
    {0,0,0,0x80|GUI_LARGE_FONT_SIZE,0,1	},
    {0,0,0,0x80|GUI_XLARGE_FONT_SIZE,0,1	},
    {0,0,0,0x80|GUI_XXLARGE_FONT_SIZE,0,1	},    
    {0,0,0,0x80|GUI_XXXLARGE_FONT_SIZE,0,1	},
};

const static stFontAttribute g_gui_font_oem_data_B [] =
{
    {1,0,0,0x80|GUI_XXSMALL_FONT_SIZE,0,1	},
    {1,0,0,0x80|GUI_XSMALL_FONT_SIZE,0,1	},
    {1,0,0,0x80|GUI_SMALL_FONT_SIZE,0,1	},
    {1,0,0,0x80|GUI_MEDIUM_FONT_SIZE,0,1	},
    {1,0,0,0x80|GUI_LARGE_FONT_SIZE,0,1	},
    {1,0,0,0x80|GUI_XLARGE_FONT_SIZE,0,1	},
    {1,0,0,0x80|GUI_XXLARGE_FONT_SIZE,0,1	},
    {1,0,0,0x80|GUI_XXXLARGE_FONT_SIZE,0,1	},
};

const static stFontAttribute g_gui_font_oem_data_I [] =
{
    {0,1,0,0x80|GUI_XXSMALL_FONT_SIZE,0,1	},
    {0,1,0,0x80|GUI_XSMALL_FONT_SIZE,0,1	},
    {0,1,0,0x80|GUI_SMALL_FONT_SIZE,0,1	},
    {0,1,0,0x80|GUI_MEDIUM_FONT_SIZE,0,1	},
    {0,1,0,0x80|GUI_LARGE_FONT_SIZE,0,1	},
    {0,1,0,0x80|GUI_XLARGE_FONT_SIZE,0,1	},
    {0,1,0,0x80|GUI_XXLARGE_FONT_SIZE,0,1	},
    {0,1,0,0x80|GUI_XXXLARGE_FONT_SIZE,0,1	},
};

const static stFontAttribute g_gui_font_oem_data_BI [] =
{
    {1,1,0,0x80|GUI_XXSMALL_FONT_SIZE,0,1	},
    {1,1,0,0x80|GUI_XSMALL_FONT_SIZE,0,1	},
    {1,1,0,0x80|GUI_SMALL_FONT_SIZE,0,1	},
    {1,1,0,0x80|GUI_MEDIUM_FONT_SIZE,0,1	},
    {1,1,0,0x80|GUI_LARGE_FONT_SIZE,0,1	},
    {1,1,0,0x80|GUI_XLARGE_FONT_SIZE,0,1	},
    {1,1,0,0x80|GUI_XXLARGE_FONT_SIZE,0,1	},
};
#else
const static stFontAttribute g_gui_font_oem_data [] =
{
...
/* 20260422 */
#ifdef __MATERIAL_UI_THEME_MODIFY_FONTRES__
    font_data = g_gui_font_type_data[index] & 0x3F;
#else
