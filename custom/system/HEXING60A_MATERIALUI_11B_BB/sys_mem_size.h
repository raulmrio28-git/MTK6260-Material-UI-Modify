 ...
 */
    #define GLOBAL_MEM_SIZE  (286840 + 26940 - 120668 - 0)
    #define TOTAL_TASK_STACK_SIZE  120668 + 0
    #define GLOBAL_DEBUG_MEM_SIZE  1260
    #define STACK_POOL_COEFFECIENT (100 - 30)
    #define STACK_POOL_SIZE        (120668 * (100 - 30)/100 + 0)
#endif  
