...
# ------------------------------ HW and Project
BOARD_VER = HEXING60A_MATERIALUI_11B_BB
  # Description:
...
UNIFIED_MESSAGE_MARK_SEVERAL_FEATURE = TRUE
  # Description:
...
SWITCHABLE_FEATURE = FLAVOR  #GEMINI #2,3,FALSE
  # Description:
...
FONT_ENGINE = FONT_ENGINE_ETRUMP
  # Description:
...
KINGMOVIE_FILE_FORMAT_SUPPORT = TRUE
  # Description:
...
WIFI_AUTHENTICATION_LEVEL = NONE
  # Description:
...
CUSTOM_OPTION     +=  __MRE_CUST_MEM_SIZE__=3072
CUSTOM_OPTION     +=  __MRE_BGMEM_SIZE__=800
CUSTOM_OPTION     +=  __CUSTOM_MRE_MAX_SIZE__=32
...
EXISTED_CUS_REL_TRACE_DEFS += vendor\mms\obigo_q03c\adaptation\integration\include\mms_trc.h 
