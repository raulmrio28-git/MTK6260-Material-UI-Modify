...
void LCD_gamma_test(kal_uint8 level, kal_uint8 color)
{
	...
	{
		case ILI9341:
			LCD_gamma_test_ILI9341(level, color);
			break;				
		default:
			ASSERT(0);			
	}
...
void LCD_flicker_test(kal_uint8 level)
{
	...
	{
		case ILI9341:
			LCD_flicker_test_ILI9341(level);
			break;				
		default:
			ASSERT(0);			
	}
