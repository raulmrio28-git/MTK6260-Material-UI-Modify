...
# baiwenlin 20130821  128X64
HORIZONTAL_CAMERA_SUPPORT_SIZE = 128X128 128X160 320X240 176X220 240X320 240X400 320X480 360X640 480X800 128X64 128X36
...
# baiwenlin 20130821  128X64
MEDIA_PLAYER_VER_MAIN_LCD_SIZE = 128X160 176X220 240X320 240X400 320X480 320X240 360X640 480X800 128X64 128X36
...
#-----------------------------------------------------------------------------------------
#20260422
ifeq ($(strip $(MATERIAL_UI_THEME)),TRUE)
  COM_DEFS += __MATERIAL_UI_THEME_MODIFY_THEMERES__
  COM_DEFS += __MATERIAL_UI_THEME_MODIFY_FONTRES__
  COM_DEFS += __MATERIAL_UI_THEME_MODIFY_STATUSBAR__
