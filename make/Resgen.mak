...
#20260423
	  ifneq ($(filter __MATERIAL_UI_THEME_MODIFY_THEMERES__,$(strip $(COM_DEFS))),)
NEED_COPY_LCDRESOURCE_DIR += $(FIXPATH)\$(MMIDIR)\Customer\LcdResource\MainLcd$(strip $(MAIN_LCD_SIZE))\material_ui
	  else
NEED_COPY_LCDRESOURCE_DIR += $(FIXPATH)\$(MMIDIR)\Customer\LcdResource\MainLcd$(strip $(MAIN_LCD_SIZE))\non_touch
      	ifneq ($(filter __LOW_COST_SUPPORT_COMMON__,$(strip $(COM_DEFS))),)
