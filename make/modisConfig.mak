...
ifeq ($(strip $(MODIS_CONFIG)),TRUE)
  ...
  LIB_MODIS := lib
  LINK_MODIS := link
  export PATH := $(strip $(WindowsSDKDir))\bin;$(strip $(VSCommonDir))\IDE;$(strip $(MSVCDir))\BIN;$(strip $(MSVCDir))\vcpackages;$(strip $(VCToolsInstallDir));$(strip $(MSBuildPath));$(strip $(PATH))
  ...
  export VCTargetsPath := $(strip $(MSBuildPropPath))
endif
